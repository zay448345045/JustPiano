...
object GlobalSetting {
    ...
    fun loadSettings(context: Context, online: Boolean) {
        ...
        // 延音和混响：数值直接更新到C++层即可
        SoundEngineUtil.setDelayValue(sharedPreferences.getString("sound_delay", "25")!!.toInt())
        SoundEngineUtil.setReverbValue(sharedPreferences.getString("sound_reverb", "25")!!.toInt())
