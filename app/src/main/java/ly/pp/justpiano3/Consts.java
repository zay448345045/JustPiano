...
public interface Consts extends BaseColumns {
    ...
    int[] fHair = new int[]{10, 10, 10, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 10, 15, 15, 15, 15, 15, 15, 25,
            25, 20, 20, 25, 25, 15, 25, 25, 25, 20, 20, 20, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25};
    int[] mHair = new int[]{10, 10, 10, 10, 15, 15, 15, 15, 10, 10, 10, 15, 15, 20, 20, 20, 20, 15, 15, 15, 20, 25, 20, 20, 25, 25};
    int[] fJacket = new int[]{10, 10, 10, 15, 15, 15, 15, 10, 10, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 25, 10, 10, 10, 10, 15, 15, 15, 15, 15, 15, 15, 15,
            15, 15, 15, 20, 30, 25, 25, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 50, 55, 55, 50, 55, 55, 50, 55, 50, 50, 50, 50, 30, 30, 25, 15};
    int[] mJacket = new int[]{10, 10, 10, 15, 15, 15, 15, 10, 10, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 25, 10, 10, 10, 15, 15, 15, 15, 15,
            15, 15, 15, 15, 15, 15, 20, 10, 20, 30, 55, 55, 55, 55, 50, 55, 75, 20, 35};
    int[] fTrousers = new int[]{10, 10, 10, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15};
    int[] mTrousers = new int[]{10, 10, 10, 10, 10, 10, 15, 15, 15, 25, 10, 10, 15, 15, 15, 10, 10, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 20, 20, 20};
    int[] fShoes = new int[]{10, 10, 10, 10, 10, 10, 10, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 20};
    int[] mShoes = new int[]{15, 15, 15, 15, 15, 15, 15, 15, 10, 10, 10, 10, 10, 10, 10, 15, 15};
}
