...
public interface Consts extends BaseColumns {
    ...
    int[] fHair = new int[]{0, 10, 10, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 10, 15, 15, 15, 15, 15, 15, 25,
            25, 20, 20, 25, 25, 15, 25, 25, 25, 20, 20, 20, 25, 25, 25, 25, 25, 25, 20, 15, 15, 15, 15, 15, 15, 15, 15, 15, 20, 20, 20, 15, 15, 20, 25, 20, 15, 15, 15, 15};
    int[] mHair = new int[]{0, 10, 10, 10, 15, 15, 15, 15, 10, 10, 10, 15, 15, 20, 20, 20, 20, 15, 15, 15, 20, 25, 20, 20, 15, 20, 20, 15, 20, 25, 15, 20, 15, 15, 15, 15, 15, 20};
    int[] fEye = new int[]{0, 20, 20, 20, 20, 20, 20, 20, 20, 20, 25, 25, 25, 25, 25, 25};
    int[] mEye = new int[]{0, 20, 20, 20, 20, 20, 20, 20, 20, 20, 25, 25, 25, 25, 25, 25};
    int[] fJacket = new int[]{0, 10, 10, 15, 15, 15, 15, 10, 10, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 25, 10, 10, 10, 10, 15, 15, 15, 15, 15, 15, 15, 15,
            15, 15, 15, 20, 30, 25, 25, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 50, 55, 55, 50, 55, 55, 50, 55, 50, 50, 50, 50, 15, 25, 25, 25, 25, 25, 25, 30, 30, 30, 20, 20, 45, 20, 20, 20, 45};
    int[] mJacket = new int[]{0, 10, 10, 15, 15, 15, 15, 10, 10, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 25, 10, 10, 10, 15, 15, 15, 15, 15,
            15, 15, 15, 15, 15, 15, 20, 10, 20, 30, 55, 55, 55, 55, 50, 55, 75, 15, 35, 20, 20, 45, 45, 15, 15, 15, 20, 40, 30, 15, 15, 20, 20, 20};
    int[] fTrousers = new int[]{0, 10, 10, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 10, 10};
    int[] mTrousers = new int[]{0, 10, 10, 10, 10, 10, 15, 15, 15, 25, 10, 10, 15, 15, 15, 10, 10, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 20, 20, 10, 15, 15, 15, 15, 10, 15, 15, 15};
    int[] fShoes = new int[]{0, 10, 10, 10, 10, 10, 10, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 10, 10, 15, 15, 15};
    int[] mShoes = new int[]{0, 15, 15, 15, 15, 15, 15, 15, 10, 10, 10, 10, 10, 10, 10, 15, 10, 10, 10, 10, 10, 10, 15, 15, 15, 10, 10, 10, 15, 15, 15, 15, 15, 15, 15, 15, 10, 10};
}
