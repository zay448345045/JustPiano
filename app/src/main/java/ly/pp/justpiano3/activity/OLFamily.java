...
public class OLFamily extends OLBaseActivity implements OnClickListener {
    ...
    public void showInfoDialog(Bundle b) {
        ...
        try {
            ...
            new JPDialogBuilder(this).setWidthWeight(0.45).setTitle("个人资料").loadInflate(inflate).setFirstButton("加为好友", new AddFriendsMailClick(this, user.getPlayerName())).setSecondButton("确定", new DialogDismissClick()).buildAndShowDialog();
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
