...
public class OLPlayRoomActivity extends OLBaseActivity implements Handler.Callback, View.OnClickListener, View.OnLongClickListener {
    ...
    protected void showCpDialog(String str, String str2) {
        ...
        try {
            ...
            new JPDialogBuilder(this).setWidthWeight(0.40).setTitle(str).loadInflate(inflate).setFirstButton("祝福:" + jSONObject4.getInt("P"), (dialog, which) -> {
                try {
    ...
    public void showInfoDialog(Bundle b) {
        ...
        try {
            ...
            new JPDialogBuilder(this).setWidthWeight(0.45).setTitle("个人资料").loadInflate(inflate).setFirstButton("加为好友", new AddFriendsClick(this, user.getPlayerName())).setSecondButton("确定", new DialogDismissClick()).buildAndShowDialog();
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
