        ...
        switch (type) {
            case 0:
                if (olPlayDressRoom.hairUnlock.contains(i)) {
                    view.findViewById(R.id.ol_dress_price).setVisibility(View.GONE);
                    view.findViewById(R.id.ol_dress_lock).setVisibility(View.GONE);
                    view.findViewById(R.id.ol_dress_gold_image).setVisibility(View.GONE);
                    ...
                    view.findViewById(R.id.ol_dress_lock).setVisibility(View.VISIBLE);
