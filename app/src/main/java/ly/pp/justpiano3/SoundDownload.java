...
public class SoundDownload extends Activity implements Callback {
    public String picUrl = "http://111.67.204.158:8910/JustPianoServer/server/PicSound";
    ...
    static void downloadSS(SoundDownload soundDownload, String str, String str2) {
        ...
        InputStream in = null;
        try {
            URL url = new URL("http://111.67.204.158:8910/JustPianoServer/server/Sound" + str);
