...
JNIEXPORT void JNICALL Java_ly_pp_justpiano3_utils_Sf2SynthUtil_free(JNIEnv* env, jobject obj, jlong ptr)
{
...
JNIEXPORT void JNICALL Java_ly_pp_justpiano3_utils_Sf2SynthUtil_open(JNIEnv* env, jobject obj, jlong ptr)
{
	fluid_handle_t *handle = NULL;
	memcpy(&handle, &ptr, sizeof(handle));
...
JNIEXPORT void JNICALL Java_ly_pp_justpiano3_utils_Sf2SynthUtil_close(JNIEnv* env, jobject obj, jlong ptr)
{
	fluid_handle_t *handle = NULL;
	memcpy(&handle, &ptr, sizeof(handle));
	if(handle != NULL){
...
JNIEXPORT void JNICALL Java_ly_pp_justpiano3_utils_Sf2SynthUtil_loadFont(JNIEnv* env, jobject obj, jlong ptr, jstring path)
{
	fluid_handle_t *handle = NULL;
	memcpy(&handle, &ptr, sizeof(handle));
...
JNIEXPORT void JNICALL Java_ly_pp_justpiano3_utils_Sf2SynthUtil_unloadFont(JNIEnv* env, jobject obj, jlong ptr)
{
	fluid_handle_t *handle = NULL;
	memcpy(&handle, &ptr, sizeof(handle));
	if(handle != NULL && handle->synth != NULL && handle->soundfont_id > 0){
...
JNIEXPORT void JNICALL Java_ly_pp_justpiano3_utils_Sf2SynthUtil_systemReset(JNIEnv* env, jobject obj, jlong ptr)
{
	fluid_handle_t *handle = NULL;
	memcpy(&handle, &ptr, sizeof(handle));
...
JNIEXPORT void JNICALL Java_ly_pp_justpiano3_utils_Sf2SynthUtil_noteOn(JNIEnv* env, jobject obj, jlong ptr, jint channel, jint note, jint velocity)
{
	fluid_handle_t *handle = NULL;
	memcpy(&handle, &ptr, sizeof(handle));
	if(handle != NULL && handle->synth != NULL){
...
JNIEXPORT void JNICALL Java_ly_pp_justpiano3_utils_Sf2SynthUtil_noteOff(JNIEnv* env, jobject obj, jlong ptr, jint channel, jint note, jint velocity)
{
	fluid_handle_t *handle = NULL;
	memcpy(&handle, &ptr, sizeof(handle));
	if(handle != NULL && handle->synth != NULL){
...
JNIEXPORT void JNICALL Java_ly_pp_justpiano3_utils_Sf2SynthUtil_programChange(JNIEnv* env, jobject obj, jlong ptr, jint channel, jint program)
{
	fluid_handle_t *handle = NULL;
	memcpy(&handle, &ptr, sizeof(handle));
	if(handle != NULL && handle->synth != NULL){
...
JNIEXPORT void JNICALL Java_ly_pp_justpiano3_utils_Sf2SynthUtil_controlChange(JNIEnv* env, jobject obj, jlong ptr, jint channel, jint control, jint value)
{
	fluid_handle_t *handle = NULL;
	memcpy(&handle, &ptr, sizeof(handle));
	if(handle != NULL && handle->synth != NULL){
...
JNIEXPORT void JNICALL Java_ly_pp_justpiano3_utils_Sf2SynthUtil_pitchBend(JNIEnv* env, jobject obj, jlong ptr, jint channel, jint value)
{
	fluid_handle_t *handle = NULL;
	memcpy(&handle, &ptr, sizeof(handle));
	if(handle != NULL && handle->synth != NULL){
...
JNIEXPORT void JNICALL Java_ly_pp_justpiano3_utils_Sf2SynthUtil_setDoubleProperty(JNIEnv* env, jobject obj, jlong ptr, jstring key, jdouble value)
{
	fluid_handle_t *handle = NULL;
	memcpy(&handle, &ptr, sizeof(handle));
...
JNIEXPORT void JNICALL Java_ly_pp_justpiano3_utils_Sf2SynthUtil_setIntegerProperty(JNIEnv* env, jobject obj, jlong ptr, jstring key, jint value)
{
	fluid_handle_t *handle = NULL;
	memcpy(&handle, &ptr, sizeof(handle));
	if(handle != NULL && handle->settings != NULL && key != NULL ){
...
JNIEXPORT void JNICALL Java_ly_pp_justpiano3_utils_Sf2SynthUtil_setStringProperty(JNIEnv* env, jobject obj, jlong ptr, jstring key, jstring value)
{
	fluid_handle_t *handle = NULL;
	memcpy(&handle, &ptr, sizeof(handle));
	if(handle != NULL && handle->settings != NULL && key != NULL ){
...
JNIEXPORT void JNICALL Java_ly_pp_justpiano3_utils_Sf2SynthUtil_getDoubleProperty(JNIEnv* env, jobject obj, jlong ptr, jstring key, jobject ref)
{
	fluid_handle_t *handle = NULL;
	memcpy(&handle, &ptr, sizeof(handle));
	if(handle != NULL && handle->settings != NULL && key != NULL ){
...
JNIEXPORT void JNICALL Java_ly_pp_justpiano3_utils_Sf2SynthUtil_getIntegerProperty(JNIEnv* env, jobject obj, jlong ptr, jstring key, jobject ref)
{
	fluid_handle_t *handle = NULL;
	memcpy(&handle, &ptr, sizeof(handle));
	if(handle != NULL && handle->settings != NULL && key != NULL ){
...
JNIEXPORT void JNICALL Java_ly_pp_justpiano3_utils_Sf2SynthUtil_getStringProperty(JNIEnv* env, jobject obj, jlong ptr, jstring key, jobject ref)
{
	fluid_handle_t *handle = NULL;
	memcpy(&handle, &ptr, sizeof(handle));
	if(handle != NULL && handle->settings != NULL && key != NULL ){
...
JNIEXPORT void JNICALL Java_ly_pp_justpiano3_utils_Sf2SynthUtil_getDoublePropertyDefault(JNIEnv* env, jobject obj, jlong ptr, jstring key, jobject ref)
{
	fluid_handle_t *handle = NULL;
	memcpy(&handle, &ptr, sizeof(handle));
	if(handle != NULL && handle->settings != NULL && key != NULL ){
...
JNIEXPORT void JNICALL Java_ly_pp_justpiano3_utils_Sf2SynthUtil_getIntegerPropertyDefault(JNIEnv* env, jobject obj, jlong ptr, jstring key, jobject ref)
{
	fluid_handle_t *handle = NULL;
	memcpy(&handle, &ptr, sizeof(handle));
	if(handle != NULL && handle->settings != NULL && key != NULL ){
...
JNIEXPORT void JNICALL Java_ly_pp_justpiano3_utils_Sf2SynthUtil_getStringPropertyDefault(JNIEnv* env, jobject obj, jlong ptr, jstring key, jobject ref)
{
	fluid_handle_t *handle = NULL;
	memcpy(&handle, &ptr, sizeof(handle));
	if(handle != NULL && handle->settings != NULL && key != NULL ){
...
JNIEXPORT void JNICALL Java_ly_pp_justpiano3_utils_Sf2SynthUtil_getDoublePropertyRange(JNIEnv* env, jobject obj, jlong ptr, jstring key, jobject minimumRef, jobject maximumRef)
{
	fluid_handle_t *handle = NULL;
	memcpy(&handle, &ptr, sizeof(handle));
	if(handle != NULL && handle->settings != NULL && key != NULL ){
...
JNIEXPORT void JNICALL Java_ly_pp_justpiano3_utils_Sf2SynthUtil_getIntegerPropertyRange(JNIEnv* env, jobject obj, jlong ptr, jstring key, jobject minimumRef, jobject maximumRef)
{
	fluid_handle_t *handle = NULL;
	memcpy(&handle, &ptr, sizeof(handle));
	if(handle != NULL && handle->settings != NULL && key != NULL ){
...
JNIEXPORT void JNICALL Java_ly_pp_justpiano3_utils_Sf2SynthUtil_getPropertyOptions(JNIEnv* env, jobject obj, jlong ptr, jstring key, jobject options)
{
	fluid_handle_t *handle = NULL;
	memcpy(&handle, &ptr, sizeof(handle));
	if(handle != NULL && handle->settings != NULL){
...
JNIEXPORT void JNICALL Java_ly_pp_justpiano3_utils_Sf2SynthUtil_isRealtimeProperty(JNIEnv* env, jobject obj, jlong ptr, jstring key, jobject ref)
{
	fluid_handle_t *handle = NULL;
	memcpy(&handle, &ptr, sizeof(handle));
	if(handle != NULL && handle->settings != NULL && key != NULL ){
