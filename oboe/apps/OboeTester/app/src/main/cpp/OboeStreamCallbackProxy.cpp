...
void
OboeStreamCallbackProxy::onErrorBeforeClose(oboe::AudioStream *audioStream, oboe::Result error) {
...
void
OboeStreamCallbackProxy::onErrorAfterClose(oboe::AudioStream *audioStream, oboe::Result error) {
    LOGD("OboeStreamCallbackProxy::%s(%p, %d) called", __func__, audioStream, error);
    if (mCallback != nullptr) {
