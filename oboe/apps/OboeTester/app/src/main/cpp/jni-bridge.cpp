...
JNIEXPORT jint
JNICALL
        Java_com_google_sample_oboe_manualtest_OboeAudioStream_setThresholdInFrames(JNIEnv * env,
                                                                                    jobject, jint,
                                                                                    jint);
JNIEXPORT jint
JNICALL
        Java_com_google_sample_oboe_manualtest_OboeAudioStream_getThresholdInFrames(JNIEnv * env,
                                                                                    jobject, jint);
JNIEXPORT jint
JNICALL
...
JNIEXPORT jint
JNICALL
        Java_com_google_sample_oboe_manualtest_OboeAudioStream_setNativeApi(JNIEnv * env, jobject,
                                                                            jint, jint);
...
JNIEXPORT jboolean
JNICALL
        Java_com_google_sample_oboe_manualtest_NativeEngine_isMMapSupported(JNIEnv * env, jclass
type ) {
...
JNIEXPORT jboolean
JNICALL
        Java_com_google_sample_oboe_manualtest_NativeEngine_isMMapExclusiveSupported(JNIEnv * env,
                                                                                     jclass
type) {
return

AAudioExtensions::getInstance()

.

isMMapExclusiveSupported();

}

JNIEXPORT void JNICALL
Java_com_google_sample_oboe_manualtest_NativeEngine_setWorkaroundsEnabled(JNIEnv
*env,
jclass type,
        jboolean
enabled) {
...
oboe::OboeGlobals::areWorkaroundsEnabled();
...
return (jint) engine.getCurrentActivity()->
open(nativeApi,
        sampleRate,
        channelCount,
        format,
...
Java_com_google_sample_oboe_manualtest_TestAudioActivity_startNative(JNIEnv * env, jobject) {
    return (jint)
    engine.getCurrentActivity()->start();
}
...
Java_com_google_sample_oboe_manualtest_TestAudioActivity_pauseNative(JNIEnv * env, jobject) {
    return (jint)
    engine.getCurrentActivity()->pause();
}
...
Java_com_google_sample_oboe_manualtest_TestAudioActivity_stopNative(JNIEnv * env, jobject) {
    return (jint)
    engine.getCurrentActivity()->stop();
}

JNIEXPORT jint

JNICALL
Java_com_google_sample_oboe_manualtest_TestAudioActivity_getFramesPerCallback(JNIEnv * env,
                                                                              jobject) {
    return (jint)
    engine.getCurrentActivity()->getFramesPerCallback();
}
...
Java_com_google_sample_oboe_manualtest_OboeAudioStream_startPlaybackNative(JNIEnv * env, jobject) {
    return (jint)
    engine.getCurrentActivity()->startPlayback();
}

JNIEXPORT void JNICALL
Java_com_google_sample_oboe_manualtest_OboeAudioStream_close(JNIEnv
*env, jobject,
jint streamIndex
) {
engine.getCurrentActivity()->
close(streamIndex);
}
...
JNIEXPORT jint
JNICALL
        Java_com_google_sample_oboe_manualtest_OboeAudioStream_getFormat(JNIEnv * env, jobject
instance,
jint streamIndex
) {
jint result = (jint)
...
JNIEXPORT jdouble
JNICALL
        Java_com_google_sample_oboe_manualtest_OboeAudioStream_getLatency(JNIEnv * env, jobject
instance,
jint streamIndex
) {
oboe::AudioStream *oboeStream = engine.getCurrentActivity()->getStream(streamIndex);
...
JNIEXPORT jdouble
JNICALL
        Java_com_google_sample_oboe_manualtest_OboeAudioStream_getCpuLoad(JNIEnv * env, jobject
instance,
jint streamIndex
) {
...
JNIEXPORT jint
JNICALL
        Java_com_google_sample_oboe_manualtest_OboeAudioStream_getState(JNIEnv * env, jobject
instance,
jint streamIndex
) {
oboe::AudioStream *oboeStream = engine.getCurrentActivity()->getStream(streamIndex);
...
if (state !=
oboe::StreamState::Starting &&state
...
JNIEXPORT void JNICALL
Java_com_google_sample_oboe_manualtest_OboeAudioStream_setUseCallback(JNIEnv
*env,
jclass type,
        jboolean
useCallback) {
...
JNIEXPORT void JNICALL
Java_com_google_sample_oboe_manualtest_OboeAudioStream_setCallbackReturnStop(JNIEnv
*env,
jclass type,
        jboolean
b) {
...
JNIEXPORT void JNICALL
Java_com_google_sample_oboe_manualtest_OboeAudioStream_setCallbackSize(JNIEnv
*env,
jclass type,
        jint
callbackSize) {
...
JNIEXPORT jboolean
JNICALL
        Java_com_google_sample_oboe_manualtest_OboeAudioStream_isMMap(JNIEnv * env, jobject
instance,
jint streamIndex
) {
return engine.getCurrentActivity()->
isMMapUsed(streamIndex);
}
...
// ==========================================================================
JNIEXPORT void JNICALL
Java_com_google_sample_oboe_manualtest_TestAudioActivity_setActivityType(JNIEnv
*env,
jobject instance,
        jint
activityType) {
...
env->
ReleaseStringUTFChars(fileName, str
);
return
result;
}
...
// ==========================================================================
JNIEXPORT void JNICALL
Java_com_google_sample_oboe_manualtest_TestInputActivity_setMinimumFramesBeforeRead(JNIEnv
*env,
jobject instance,
        jint
numFrames) {
engine.getCurrentActivity()->
setMinimumFramesBeforeRead(numFrames);
}

// ==========================================================================
JNIEXPORT void JNICALL
Java_com_google_sample_oboe_manualtest_EchoActivity_setDelayTime(JNIEnv
*env,
jobject instance,
        jdouble
delayTimeSeconds) {
...
JNIEXPORT jint
JNICALL
        Java_com_google_sample_oboe_manualtest_RoundTripLatencyActivity_getAnalyzerProgress(
        JNIEnv * env,
        jobject
instance) {
...
JNIEXPORT jint
JNICALL
        Java_com_google_sample_oboe_manualtest_RoundTripLatencyActivity_getMeasuredLatency(
        JNIEnv * env,
        jobject
instance) {
...
JNIEXPORT jdouble
JNICALL
        Java_com_google_sample_oboe_manualtest_RoundTripLatencyActivity_getMeasuredConfidence(
        JNIEnv * env,
        jobject
instance) {
...
JNIEXPORT jdouble
JNICALL
        Java_com_google_sample_oboe_manualtest_RoundTripLatencyActivity_getBackgroundRMS(
        JNIEnv * env,
        jobject
instance) {
...
JNICALL
        Java_com_google_sample_oboe_manualtest_AnalyzerActivity_getAnalyzerState(JNIEnv * env,
                                                                                 jobject
instance) {
return ((ActivityFullDuplex *)engine.
...
return engine.mActivityGlitches.getGlitchAnalyzer()->
getStateFrameCount(state);
}
...
JNIEXPORT void JNICALL
Java_com_google_sample_oboe_manualtest_GlitchActivity_setTolerance(JNIEnv
*env,
jobject instance,
        jfloat
tolerance) {
if (engine.mActivityGlitches.

getGlitchAnalyzer()

) {
engine.mActivityGlitches.getGlitchAnalyzer()->
...
JNIEXPORT jint
JNICALL
        Java_com_google_sample_oboe_manualtest_ManualGlitchActivity_getGlitch(JNIEnv * env, jobject
instance,
...
env->
ReleaseFloatArrayElements(waveform_, waveform,
0);
return
numSamples;
}
